        ...
        >
          ...
          <div className="glass-card rounded-3xl border border-white/10 p-8 md:p-10 shadow-[0_0_80px_rgba(173,198,255,0.05)] relative overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <h2 className="text-[28px] font-bold tracking-tight text-white mb-2">Create Account</h2>
              <p className="text-white/50 font-body-md text-[14px]">
                Start broadcasting in high-definition today
              </p>
            </div>
            ...
            <form onSubmit={handleSignUp}  className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={isLoading}
                    className="w-full pl-11 pr-4 py-3 tech-input rounded-2xl font-body-md text-[14px]"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={isLoading}
                    className="w-full pl-11 pr-12 py-3 tech-input rounded-2xl font-body-md text-[14px]"
                  />
                  <button
                    type="button"
              ...
              <motion.button
                ...
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-primary to-tertiary text-on-primary font-label-md text-label-md font-bold py-3.5 rounded-2xl flex items-center justify-center gap-2 cursor-pointer shadow-[0_0_15px_rgba(173,198,255,0.2)] disabled:opacity-50 disabled:cursor-not-allowed transition-all mt-6"
              >
                {isLoading ? (
                  <>
            ...
            <div className="relative my-7">
              ...
              <div className="relative flex justify-center text-[11px] uppercase tracking-widest">
                <span className="bg-[#0b1021] px-3 text-white/40">Or register with</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3.5">
              <motion.button
                ...
                disabled={isLoading}
                className="py-2.5 rounded-2xl border border-white/10 hover:border-white/20 bg-white/5 hover:bg-white/10 flex items-center justify-center gap-2 cursor-pointer text-white/70 hover:text-white font-label-md text-[13px] transition-all"
              >
